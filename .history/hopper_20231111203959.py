    ...
    def simulate(self):
        ...
        while not glfw.window_should_close(self.window):
            ...
            if (current_time - start_time) % 2 < 0.1: 
                ...
                bodyid:int = mj.mj_name2id(self.model, mj.mjtObj.mjOBJ_BODY, "hopper")
                print('bodyid', bodyid)
                if bodyid >= 0 and self.model.body_jntnum[bodyid] == 1 and self.model.jnt_type[self.model.body_jntadr[bodyid]] == mj.mjtJoint.mjJNT_FREE:
