    ...
    def simulate(self):
        ...
        while not glfw.window_should_close(self.window):
            ...
            if (current_time - start_time) % 2 < 0.1: 
                ...
                siteid:int = mj.mj_name2id(self.model, mj.mjtObj.mjOBJ_SITE, "hip_left")
                print('jointid', siteid)
                if (siteid >= 0):
                    qposadr = self.model.jnt_qposadr[siteid]
                    qveladr = self.model.jnt_dofadr[siteid]
